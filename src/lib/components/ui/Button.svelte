...
<script lang="ts">
  ...
  export let variant: "solid" | "bordered" | "light" | "flat" | "ghost" =
    "solid";
  export let color:
    | "default"
    | "primary"
    ...
    compoundVariants: [
      {
        ...
        color: "primary",
        class:
          "bg-gradient-to-r from-cyan-600 to-cyan-600 text-white hover:shadow-lg hover:shadow-cyan-500/50 hover:-translate-y-0.5 focus:ring-cyan-500",
      },
      {
        variant: "solid",
        color: "danger",
        class:
          "bg-gradient-to-r from-red-600 to-red-700 text-white hover:shadow-lg hover:shadow-red-500/50 hover:-translate-y-0.5 focus:ring-red-500",
      },
      {
        variant: "bordered",
        color: "primary",
        class:
          "border-cyan-500 text-cyan-400 hover:bg-cyan-500/10 focus:ring-cyan-500",
      },
      {
        variant: "flat",
        color: "default",
