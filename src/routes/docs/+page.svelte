  ...
  <section class="pt-32 pb-16 px-8">
    <div class="max-w-6xl mx-auto text-center">
      ...
      <p class="text-xl text-slate-400">
        Everything you need to know about using Rivara Wallet
      </p>
    </div>
  </section>
  ...
  <section class="pb-32 px-8">
    <div class="max-w-7xl mx-auto flex gap-8">
              ...
              <div class="mb-6 last:mb-0">
                ...
                <div class="space-y-1">
                  {#each section.items as item}
                    <button
                      class="w-full text-left px-3 py-2 rounded-lg text-sm transition-all {activeSection ===
                      item.id
      ...
      <main class="flex-1 space-y-8">
          ...
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-6">
                Creating a new wallet generates a unique 12-word seed phrase
                that controls your crypto.
              </p>

              <div class="space-y-4">
                <div class="flex gap-3">
                  <div
                    class="flex-shrink-0 w-8 h-8 rounded-full bg-cyan-600 flex items-center justify-center font-bold text-sm"
                  >
                    1
                  </div>
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      From the landing page, click the "Create Wallet" button.
                    </p>
                  </div>
                </div>
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      You'll see 12 words. Write them down on paper in order.
                      Never store them digitally or take a screenshot.
                    </p>
                  </div>
                </div>
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      Create a strong password to encrypt your wallet. This
                      password is only for this device.
                    </p>
                  </div>
                </div>
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      Your wallet is created and ready to use. Keep your seed
                      phrase safe!
                    </p>
                  </div>
                </div>
              ...
              >
                <p class="text-yellow-200 text-sm">
                  <strong>⚠️ Important:</strong> Your seed phrase is the ONLY way
                  to recover your wallet. If you lose it, your crypto is gone forever.
                </p>
              </div>
            </div>
          </Card>
        ...
        <div id="import-wallet">
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <div class="space-y-4">
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      From the landing page, click "Import Wallet".
                    </p>
                  </div>
                </div>
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      Type or paste your 12-word seed phrase. Make sure the
              ...
              <div
                class="mt-4 p-3 bg-cyan-500/10 border border-cyan-500/20 rounded-lg"
              >
                <p class="text-cyan-200 text-sm">
                  <strong>💡 Tip:</strong> Rivara uses standard BIP39 seed phrases.
                  You can import wallets from other BIP39-compatible wallets.
                </p>
              </div>
            </div>
          </Card>
          ...
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-4">
                Rivara offers two backup methods: seed phrase and Tuffbackup.
              </p>

              <h3 class="text-lg font-semibold text-white mb-2 mt-4">
                Seed Phrase Backup
              </h3>
              <p class="text-sm text-slate-400 mb-4">
                Your 12-word seed phrase is the master backup. Write it down and
              ...
              <p class="text-sm text-slate-400 mb-3">
                Tuffbackup creates an encrypted file containing your wallet.
                It's protected by your password.
              </p>
              ...
              <div class="grid md:grid-cols-2 gap-3">
                <div class="p-3 bg-white/5 rounded-lg border border-white/10">
                  ...
                  >
                    ...
                    <li>
                      Save the <code class="text-cyan-300"
                        >tuffbackup.rivara</code
                      > file
                    </li>
                  </ol>
                </div>
            ...
            <div class="p-6 md:p-8">
              ...
              <div class="space-y-4">
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      Click on the crypto you want to send from your wallet.
                    </p>
                  </div>
                </div>
                <div class="flex gap-3">
                ...
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      Double-check the address and amount. Crypto transactions
                      cannot be reversed!
                    </p>
                  </div>
                </div>
              ...
              >
                <p class="text-red-200 text-sm">
                  <strong>⚠️ Warning:</strong> Always verify the recipient address.
                  Sending to the wrong address means your crypto is lost forever.
                </p>
              </div>
            </div>
          </Card>
        ...
        <div id="receive">
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-4">
                To receive crypto, share your wallet address with the sender.
              </p>
              <div class="space-y-4">
                <div class="flex gap-3">
                  <div
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      Click on the crypto you want to receive.
                    </p>
                  </div>
                </div>
                <div class="flex gap-3">
              ...
              >
                <p class="text-cyan-200 text-sm">
                  <strong>💡 Tip:</strong> Each cryptocurrency has its own address.
                  Make sure you're sharing the correct address for the crypto you
                  want to receive.
                </p>
              </div>
            </div>
        ...
        <div id="exchange">
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-4">
                Rivara has a built-in exchange powered by ChangeNow. Swap crypto
              ...
              <div class="space-y-4">
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      Click "Exchange" in the navigation.
                    </p>
                  </div>
                </div>
                <div class="flex gap-3">
                ...
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      Type the amount you want to exchange. You'll see the
                ...
                <div class="flex gap-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-slate-400">
                      Review the details and confirm. The exchange will process
                      automatically.
                    </p>
                  </div>
                </div>
        ...
        <div id="portfolio">
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-4">
                The Portfolio page shows your total balance across all
                cryptocurrencies with charts and history.
              </p>
              <ul class="space-y-2">
                <li class="flex items-start gap-2">
                  ...
                  />
                  <div class="text-sm">
                    <strong class="text-white">Total Balance:</strong>
                    <span class="text-slate-400"
                      >See your combined USD value</span
                    >
                  </div>
                </li>
                <li class="flex items-start gap-2">
                  ...
                  />
                  <div class="text-sm">
                    <strong class="text-white">Asset Breakdown:</strong>
                    <span class="text-slate-400"
                      >View percentage allocation</span
                    >
                  </div>
                </li>
                <li class="flex items-start gap-2">
                  ...
                  />
                  <div class="text-sm">
                    <strong class="text-white">Price Charts:</strong>
                    <span class="text-slate-400">Track price movements</span>
                  </div>
                </li>
                <li class="flex items-start gap-2">
                  <ChevronRight
                  ...
                  />
                  <div class="text-sm">
                    <strong class="text-white">Transaction History:</strong>
                    <span class="text-slate-400">See all your transactions</span
                    >
                  </div>
                </li>
              </ul>
        ...
        <div id="seed-phrase">
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-4">
                Your seed phrase is the most important thing to protect. Here's
                how to keep it safe:
              </p>
              ...
              <div class="grid md:grid-cols-2 gap-4">
                ...
                >
                  <h4 class="text-base font-semibold text-green-400 mb-3">
                    ✅ DO
                  </h4>
                ...
                >
                  <h4 class="text-base font-semibold text-red-400 mb-3">
                    ❌ DON'T
                  </h4>
                  <ul class="space-y-1.5 text-sm text-slate-300">
        ...
        <div id="tuffbackup">
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-4">
                Tuffbackup is Rivara's encrypted backup system. It's a single
                file that contains your entire wallet.
              </p>
              ...
              <ul class="space-y-1.5 text-sm text-slate-400 mb-4">
                ...
                <li>
                  • The encrypted data is saved to a <code class="text-cyan-300"
                    >tuffbackup.rivara</code
                  > file
                </li>
                <li>
                  • You can restore your wallet by uploading this file and
                  entering your password
                </li>
              </ul>

              <div
                class="p-3 bg-cyan-500/10 border border-cyan-500/20 rounded-lg"
              >
                <p class="text-cyan-200 text-sm">
                  <strong>💡 Tip:</strong> Store your Tuffbackup file on a USB drive
                  or external hard drive. Don't rely on it as your only backup - always
                  keep your seed phrase written down too.
                </p>
              </div>
            </div>
          </Card>
        ...
        <div id="auto-lock">
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-4">
                Rivara automatically locks your wallet after a period of
                inactivity to protect your crypto.
              </p>
              ...
              <p class="text-sm text-slate-400">
                When locked, you'll need to enter your password to unlock the
                wallet again.
              </p>
            </div>
          </Card>
        ...
        <div id="supported-coins">
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-4">
                Rivara supports 8 major cryptocurrencies:
              </p>

              <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div class="p-3 bg-white/5 rounded-lg border border-white/10">
                  <h4 class="font-semibold text-white mb-0.5 text-sm">
                    Bitcoin (BTC)
                  </h4>
        ...
        <div id="standards">
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-4">
                Rivara uses industry-standard protocols for maximum
                compatibility.
              </p>
              ...
              <p class="text-sm text-slate-400 mb-2">
                Rivara uses BIP39 standard for seed phrase generation. This
                means:
              </p>
              <ul class="space-y-1.5 text-sm text-slate-400 mb-4">
              ...
              <p class="text-sm text-slate-400 mb-2">
                Rivara uses standard derivation paths for each cryptocurrency:
              </p>
        ...
        <div id="privacy">
          <Card variant="elevated">
            <div class="p-6 md:p-8">
              ...
              <p class="text-slate-300 mb-4">
                Rivara is built with privacy in mind.
              </p>
              ...
              >
                <p class="text-cyan-200 text-sm">
                  <strong>💡 Note:</strong> All wallet data is stored locally in your
                  browser. Rivara servers never see your seed phrase, private keys,
                  or passwords.
                </p>
              </div>
            </div>
        ...
        <Card variant="elevated">
          <div
            class="p-8 md:p-12 text-center bg-gradient-to-br from-cyan-900/20 to-cyan-900/20"
          >
