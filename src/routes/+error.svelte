...
<div class="min-h-screen bg-[#070b10] flex items-center justify-center p-6">
  <div class="max-w-2xl w-full">
    <!-- Error Card -->
    <div
      class="bg-stone-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 md:p-12 text-center"
    >
      <!-- Icon -->
      <div class="mb-6 flex justify-center">
        <div
          class="w-20 h-20 rounded-full bg-red-500/10 border border-red-500/20 flex items-center justify-center"
        >
      ...
      <!-- Status Code -->
      <div
        class="text-8xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-cyan-400 mb-4"
      >
        {status}
      </div>
      ...
      <div
        class="mb-8 p-4 bg-black/20 border border-white/5 rounded-lg"
        style="display: {message && status !== 404 ? 'block' : 'none'}"
      >
