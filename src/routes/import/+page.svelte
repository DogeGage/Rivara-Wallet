  ...
  async function handleTuffbackupImport(e: Event) {
    ...
    try {
      ...
      if (result.privateKeysRestored.length > 0)
        notes.push(
          `private keys restored: ${result.privateKeysRestored.join(", ")}`,
        );
        ...
        <p class="text-slate-400">
          {step === 1
            ...
            : step === 2
              ...
              : "Upload your .rivara or .dogegage backup file"}
        </p>
      </div>
        ...
        <form on:submit={handleTuffbackupImport} class="space-y-6">
          <div>
            ...
            >
              {backupFile
                ? backupFile.name
                : "Choose .rivara or .dogegage file..."}
            </button>
            <p class="text-xs text-slate-500 mt-1">
              Select your Tuffbackup file
            </p>
            {#if importNotes}
          ...
          <div>
            ...
            />
            <p class="text-xs text-slate-500 mt-1">
              The password you used when creating the backup
            </p>
          </div>
